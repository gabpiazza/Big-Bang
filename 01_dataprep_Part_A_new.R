...
##
## Notes: I am now selecting a few countries only  I do the matchind to the Orbis Stata files. I do the rest in other files
##   
##
...
suppliers_2016 <- read_excel(here("Analysis","data_raw","21_10_27_Suppliers_cern_2016_nocontacts.xlsx"))
suppliers_2016<- clean_names(suppliers_2016)
suppliers_2021 <- read_excel(here("Analysis","data_raw","2021-06-29 - CERN Orders 2014-2021_clean.xlsx"))
suppliers_2021<- clean_names(suppliers_2021)


### 2.2 Registered firm (potential suppliers) ---------------------------

potential_suppliers<- read_csv(here("Analysis","data_raw","22_03_08_potential_suppliers_procurement.csv"))
...
# I load the datasets for both years - I should have dropped the duplicates
...
#####  Write csv -----------------------------------------------------------
 ...
 #France
  suppliers_france_1<- suppliers_france[1:999,]
...
matched_italy_orbis <- read_excel("data_proc/Matched_orbis_suppliers/Export_suppliers_italy_matched.xlsx")
