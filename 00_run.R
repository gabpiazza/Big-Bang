...
if (run_01_dataprep) source(here("scripts", "01_dataprep.R"), encoding = "UTF-8")
# INPUTS
...
if (run_02_reg) source(here("scripts", "02_reg.R"), encoding = "UTF-8")
# INPUTS
...
if (run_03_table) source(here("scripts", "03_table.R"), encoding = "UTF-8")
# INPUTS 
...
if (run_04_graph) source(here("scripts", "04_graph.R"), encoding = "UTF-8")
# INPUTS
#  here("proc", "example.rds") # 01_ex_dataprep.R
# OUTPUTS
